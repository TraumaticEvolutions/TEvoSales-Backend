...
/**
 * Filtro que intercepta las peticiones y autentica al usuario usando JWT.
 * El JWT contiene información como el username y los roles de usuario.
 * También carga los roles como authorities.
 *
 * @author Ángel Aragón
 */
@Component
